(function () {
  ...
  const DEFAULT_STATE = {
    ...
    brandMust:
      "벤딕트·실버라이닝 퓨어 PRO 정확 표기 · 유튜브 '유료 프로모션 포함' 설정 · 본문/고정댓글 링크 https://wlo.kr/mkDqFW · 태그 #벤딕트 #차량용청소기 · 설명란 키워드(벤딕트, 차량용 청소기) · 댓글 이벤트: 리뷰 제품을 구독자 3명에게 증정(브랜드·제품 긍정 댓글 유도 가능)",
    brandAvoid:
